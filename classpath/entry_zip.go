...
func (self *ZipEntry) readClass(className string) ([]byte, Entry, error){
	...
	if classFile == nil {return nil, nil, errors.New("class not found: " + className)}
...
func (self *ZipEntry) getReadCloser() error {
	// openReader 将返回一个 ReadCloser
